...
import { GetSiteMapAPI } from './api/GetSiteMapAPI';
import { GetPreviewPageByPageIDAPI } from './api/GetPreviewPageByPageIDAPI';
import { GetPreviewSiteMapAPI } from './api/GetPreviewSiteMapAPI';
...
const APIResponseMap = {
  ...
  GetSiteMap: SiteMapGetResponse,
  GetPreviewPageByPageID: PageInfoGetResponse,
  GetPreviewSiteMap: SiteMapGetResponse,
...
export class RestApiService {
  ...
  constructor(
    ...
    this.apiFactory.registerApi(new GetSiteMapAPI());
    this.apiFactory.registerApi(new GetPreviewPageByPageIDAPI());
    this.apiFactory.registerApi(new GetPreviewSiteMapAPI());
