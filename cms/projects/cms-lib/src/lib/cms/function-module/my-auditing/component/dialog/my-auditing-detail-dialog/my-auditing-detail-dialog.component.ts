...
@Component({
  selector: 'cms-my-auditing-detail-dialog',
  templateUrl: './my-auditing-detail-dialog.component.html',
  styleUrls: ['./my-auditing-detail-dialog.component.css']
})
export class MyAuditingDetailDialogComponent extends CustomDialogBase implements OnInit {
  title = '審核紀錄';
  actions;
